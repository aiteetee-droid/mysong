...
mysong – a personal content tool where the owner turns places, pictures, and quotes into songs, then publishes and manages them for public visitors to enjoy.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494638+aiteetee-droid@users.noreply.github.com"
  git config user.name "aiteetee-droid"
  ```
